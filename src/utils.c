...
void printWhite(char const * text) { printInColor(text, WHITE); }

// Prints text in red : see zenithar.h
void printRed(char const * text) { printInColor(text, RED); }

// Prints text in green : see zenithar.h
void printGreen(char const * text) { printInColor(text, GREEN); }

// Prints text in yellow : see zenithar.h
void printYellow(char const * text) { printInColor(text, YELLOW); }

// Prints text in blue : see zenithar.h
void printBlue(char const * text) { printInColor(text, BLUE); }
