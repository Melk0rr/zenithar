 ...
 */
bool isUserDListEmpty(UserDList * const uli);
 ...
 */
int userDListLength(UserDList * const uli);
 ...
 */
user * getFirstUserDListNode(UserDList * const uli);
 ...
 */
user * getLastUserDListNode(UserDList * const uli);
